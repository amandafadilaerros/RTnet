...
class ktpSeeder extends Seeder
{
    ...
    {
        $data =[
            ['NIK'=>1212,'no_kk'=>12345678,'nama'=>'Yoga', 'tempat'=>'Malang', 'tanggal_lahir'=>'2024-05-21', 'jenis_kelamin'=>'l', 'golongan_darah'=>'A', 'agama'=>'Islam', 'status_perkawinan'=>'belum kawin','pekerjaan'=>'mahasiswa', 'status_keluarga'=>'Anak', 'status_anggota'=>'keluarga', 'jenis_penduduk'=>'Tetap'],
