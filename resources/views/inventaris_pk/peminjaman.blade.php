      ...
      <table class="table table-bordered table-hover table-sm" id="table_user">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td>12-02-2024</td>
                <td>
                    <button class="btn btn-sm btn-primary mt-1" style="border-radius: 20px; background-color: #717171; min-width: 170px; max-width: 70%;" type="submit">Selesai</button>
                </td>
            {{-- </tr>
            <tr>
                <td>3</td>
                ...
                <td>12-02-2024</td>
                <td>
                    <button class="btn btn-sm btn-primary mt-1" style="border-radius: 20px; background-color: #424874; min-width: 170px; max-width: 70%;" type="submit">Kembalikan</button>
                </td>
            </tr> --}}
        </tbody>
      </table>
